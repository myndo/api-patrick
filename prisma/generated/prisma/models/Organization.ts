...
export type OrganizationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"createdAt" | "updatedAt" | "deletedAt" | "id" | "name" | "description" | "userId", ExtArgs["result"]["organization"]>
...
export interface OrganizationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const organizationWithCreatedAtOnly = await prisma.organization.findMany({ select: { createdAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Organizations and only return the `createdAt`
   * const organizationWithCreatedAtOnly = await prisma.organization.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Organizations and only return the `createdAt`
   * const organizationWithCreatedAtOnly = await prisma.organization.updateManyAndReturn({
   *   select: { createdAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
